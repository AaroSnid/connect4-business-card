...
void EXTI2_3_IRQHandler(void)
{
  ...
  HAL_GPIO_EXTI_IRQHandler(INPUT_3_Pin);
...
void EXTI4_15_IRQHandler(void)
{
  ...
  HAL_GPIO_EXTI_IRQHandler(INPUT_4_Pin);
  HAL_GPIO_EXTI_IRQHandler(INPUT_5_Pin);
  HAL_GPIO_EXTI_IRQHandler(INPUT_6_Pin);
  HAL_GPIO_EXTI_IRQHandler(INPUT_7_Pin);
